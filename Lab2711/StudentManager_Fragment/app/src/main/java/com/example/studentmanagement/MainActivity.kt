...
class MainActivity : AppCompatActivity(), OnStudentFragment {
    ...
    override fun showRemoveStudentFragment(position: Int, student: StudentModel) {
        //findNavController(R.id.nav_host_fragment).navigate(R.id.removeStudentFragment)
    }

    override fun showEditStudentFragment(position: Int, student: StudentModel) {
...
public interface OnStudentFragment{
    ...
    fun showRemoveStudentFragment(position: Int, student: StudentModel)
    fun showEditStudentFragment(position: Int, student: StudentModel)
}
